...
const filterItems = [
  ...
  { id: 'data-viz', name: 'Data Visualization', count: 1 },
  { id: 'web-dev', name: 'Web Development', count: 8 },
  { id: 'ai-ml', name: 'AI & Machine Learning', count: 3 },
  { id: 'mobile', name: 'Mobile Apps', count: 4 },
  { id: 'blockchain', name: 'Blockchain', count: 2 },
  { id: 'cloud', name: 'Cloud Solutions', count: 5 },
];
    ...
    <div className="flex flex-col items-start gap-y-16 lg:gap-y-24">
      ...
      <div className="flex flex-col items-start">
        ...
        <p className="text-text-secondary text-lg mb-8 max-w-2xl leading-relaxed">
          Cross-platform travel application built with React Native and Flutter, featuring real-time booking, 
          payment integration, and seamless user experience across iOS and Android platforms.
        </p>
        <Link
          href="https://tamalsen.dev/project/tryotel-cross-platform-travel-app/"
              ...
              <li key={item.id} className="flex items-center gap-x-2">
                ...
                >
                  ...
                  <sup className="ml-px -top-[0.2em] relative text-xs font-normal">
                    {item.id === 'all' ? item.count : String(item.count).padStart(2, '0')}
                  </sup>
                </button>
              </li>
            ))}
